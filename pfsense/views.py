...
def add_port_forward_rules(request_id):
    ...
    for destination_port, ip_add, descr in zip(dest_ports, ip_adds, descrs):
        associated_rule_id = pfsense.add_firewall_rule(protocol, destination_port, ip_add, descr)
        pfsense.add_port_forward_rule(protocol, destination_port, ip_add, local_port, descr, associated_rule_id)
